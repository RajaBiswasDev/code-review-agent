...
const (
	...
	codeReviewSystemPrompt = "You are an experienced Go, Scala and Java developer. Please review the following code snippet for readability, " +
		"code style, performance, and potential bugs. Return feedback in text."
)
...
// Agent interacts with the Anthropic API
type Agent struct {
	client           *anthropic.Client
	getUserMessage   func() (string, bool)
	getSystemMessage func(string) *anthropic.MessageParam
...
func (a *Agent) runInference(ctx context.Context, conversation []anthropic.MessageParam) (*anthropic.Message, error) {
	...
	message, err := invokeModel(ctx, a.client, conversation, anthropicTools)
	return message, err
}

func invokeModel(ctx context.Context, client *anthropic.Client, conversation []anthropic.MessageParam, anthropicTools []anthropic.ToolUnionParam) (*anthropic.Message, error) {
